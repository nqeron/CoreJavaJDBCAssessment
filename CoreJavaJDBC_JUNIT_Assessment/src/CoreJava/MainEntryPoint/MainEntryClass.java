...
//    ================================================================================================================================
    public void allIntructors() throws ClassNotFoundException, IOException {
        InstructorDAOI insDAO = new InstructorDAO();
    ...
    public void allCourse() throws ClassNotFoundException, IOException {
        CourseDAOI coDAO = new CourseDAO();
    ...
    public void allCoursesWithInstructor() {
        TeachingDAOI teaDAO = new TeachingDAO();
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, StudentRegistrationException {
        ...
        int InsOrStu = -1;
        Instructor ins = null;  InstructorDAOI insDAO = null;   String insROLE = "";
        
        
        Student stu = null;     StudentDAOI stuDAO = null;
        
        Course co = null;       CourseDAOI coDAO = null;
        
        Attending att = null;   AttendingDAOI attDAO = null;
        
        Teaching tea = null;    TeachingDAOI teaDAO = null;
